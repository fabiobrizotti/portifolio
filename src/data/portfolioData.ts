...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    role: "Empreendedor & Desenvolvedor de Sistemas",
    headline: "Transformo problemas reais de negócios em produtos digitais, automações eficientes e arquiteturas escaláveis — do mapeamento da dor à entrega da solução.",
    availabilityStatus: "Disponível para novos desafios",
    shortBio: "Técnico em Desenvolvimento de Sistemas pela ETEC Dr. Nelson Alves Vianna, fundador da B&B Doceria e criador da Anne IA — uma plataforma self-hosted que nasceu da necessidade prática de automatizar atendimentos comerciais no WhatsApp.",
    fullBio: [
  ...
  projects: [
    ...
    },
    {
      ...
      description: "Operação completa de negócio de confeitaria durante 9 meses em 2024. Responsável pela gestão de produção, controle de estoque, fluxo de caixa, precificação por markup e atendimento comercial. A experiência gerou os requisitos técnicos que embasaram o desenvolvimento da Anne IA.",
    ...
    },
    {
      ...
      description: "Atuação como monitor técnico responsável pelo suporte e manutenção dos laboratórios de informática, diagnóstico de redes, configuração de ambientes de desenvolvimento e orientação a estudantes e professores.",
  ...
  experiences: [
    {
      ...
      company: "B&B Doceria",
      period: "2024 (9 meses)",
      description: "Fundação e gestão completa de microempresa no setor alimentício, atuando diretamente na produção, controle financeiro, atendimento comercial e mapeamento de processos operacionais.",
      highlights: [
